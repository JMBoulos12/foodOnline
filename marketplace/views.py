...
def search(request):
    if not 'address' in request.GET:
        ...
        fetch_vendors_by_fooditems = FoodItem.objects.filterfetch_vendors_by_fooditems = FoodItem.objects.filter(food_title__icontains=keyword, is_available=True).values_list('food_title', flat=True)
